...
let B = 100;
class EnviarS extends Component {
    constructor() {
        super();
        this.state = {
    ...
    render() {
        ...
        var Admin = this.state.Estudiante.map((E, i) => {
            if (E.id === a) {
                B = B + 3;
                ADMIN = E.Nombre;
                this.state.NombreUsuario = E.Nickname
                this.state.id = B
                ADMIN1 = E.Nickname
            }
        });
                ...
                return (
                    <div className="card" >
                        <div className="card-body">
                            ...
                            <button className="btn btn-light" onClick={() => this.Validar}>Aceptar  </button>
                        </div>  </div>
                );
            }
        });
        ...
        return (
            ...
            <div>
                <form on onSubmit={this.submitHandler}>
                    ...
                    <h2><span className="badge badge-primary" value="NombreUsuario" name="NombreUsuario">Usuario :{ADMIN}</span>
                    ...
                    <  div className="container-fluid" align="center">
                        <div className="col-md-4 text-center">
                            ...
                            <div className="form-group">
                                ...
                                <select class="selectpicker" name="Amigo" defaultValue={Amigo} onChange={this.changeHandler} >
