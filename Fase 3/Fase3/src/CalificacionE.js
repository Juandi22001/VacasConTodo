...
class CalificacionE extends Component {
      ...
      render() {
       ...
       ADMIN=E.Nombre;
        ...
        var Ingreso = this.state.RegistroActividades.map((E, i) => {
            if(E.Usuario===this.state.Usuario && E.Valor==="Aceptado"){
                      return (
              
              
                      <option key={E.Actividad}  > {E.Actividad}</option>
