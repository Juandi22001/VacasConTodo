...
class PerfilC extends Component{
  constructor(){
    super();
    this.state={
    curso :[],
  ...
  this.setState({
    ...
    Delete = async (id)=>{
 axios.delete('http://localhost:3200/Catedratico/'+id);
      this.Noti3();
    ...
    CursoUsuario.push("-----")
          ...
          return (
            ...
            <div className="App">
                ...
                <a className="navbar-brand" href="http://localhost:3000/MensajeCatedratico" >Mensaje</a>

                <a className="navbar-brand" href="http://localhost:3000/AsignarCursoC" >Curso</a>
