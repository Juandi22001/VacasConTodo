...
class AsignarCursoC extends Component {
  constructor() {
    super();
    this.state = {
      id: '',
  ...
  render() {
    ...
    var colaborador = this.state.colaborador.map((E3, i) => {
      if (E3.id === a) {
      ...
      <div>
        <form on onSubmit={this.submitHandler}>
          <nav className="navbar navbar-dark bg-primary">
            ...
            <a className="navbar-brand" href="http://localhost:3000/AsignarCursoC" >Cursos</a>

            <a className="navbar-brand" href="http://localhost:3000/PerfilC" >Perfil</a>



          </nav>

          <h1><span className="badge badge-primary">Asignar Titularidad</span>
