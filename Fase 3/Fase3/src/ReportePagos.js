...
<a className="navbar-brand" href="http://localhost:3000/PagosA" > RegistroPagos</a>       
 ...
 <h1><span className="badge badge-primary">Reporte Pagos</span> 
 ...
 <table className="table" >
   <thead className="thead-secondary">
    ...
    <th scope="col" align="left"> Pago de entradas realizadas por los estudiantes que asisten al congreso</th>
    
    
    
      <th scope="col">Ingreso total de las entradas vendidas </th>
