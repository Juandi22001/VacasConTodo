...
class MensajeEstudiante extends Component {
    constructor() {
        super();
        this.state = {
...
<input type="text" className="form-control" placeholder="Usuario" aria-label="Username" aria-describedby="addon-wrapping"  name ="Destinatario"value ={Destinatario} onChange={this.changeHandler } ></input>
...
<input type="text" className="form-control" placeholder="Usuario" aria-label="Username" aria-describedby="addon-wrapping"  name ="UsuarioR"value ={UsuarioR} onChange={this.changeHandler } ></input>
...
export default MensajeEstudiante