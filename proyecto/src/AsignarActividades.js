...
<input type="text" className="form-control" placeholder="idUsuario" aria-label="Username" aria-describedby="addon-wrapping" name="idUsuario" value ={idUsuario} onChange={this.changeHandler }></input>

<input type="text" className="form-control" placeholder="Actividad" aria-label="Username" aria-describedby="addon-wrapping"  name ="Actividad"value ={Actividad} onChange={this.changeHandler } ></input>
