...
class ReporteSinEncargado extends Component{
  constructor(){
    super();
    this.state={
    Encargado :'',
    ...
    CursoUsuario.push("-----")
            ...
            var Contact = this.state.Contacto.map((E2, i)=>{
                ...
                return (
                    ...
                    <option key={E2.Nombre}  > {E2.Nombre}</option>
                          ...
                          var Contact2 = this.state.Contacto.map((Contact, i)=>{
                
                            if(Contact.Nombre===this.state.Encargado){
                            return (
...
if(E3.Encargado===this.state.Encargado){
          ...
          return (
            ...
            <h1> <span className="badge badge-primary"> Reporte Contacto Sin Encargado </span> 
...
{Contact2}
  ...
  export default ReporteSinEncargado;