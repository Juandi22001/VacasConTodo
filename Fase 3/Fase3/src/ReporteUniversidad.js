...
import logo from './universidad.svg';
import './App.css';
...
class ReporteUniversidad extends Component {
    constructor() {
        super();
        this.state = {
    ...
    render() {
        ...
        var A_Catedratico33 = this.state.Catedratico.map((c1, i) => { 
            if(this.state.Universidad===c1.Universidad){   return (
                   ...
                   <h5 className="card-title">  {c1.Registro} </h5>
        ...
        var A_Admin33 = this.state.Admin.map((c1, i) => {
            if(this.state.Universidad===c1.Universidad){   return (
                   ...
                   <h5 className="card-title">  {c1.Puesto} </h5>
        ...
        const { Destinatario, Mensaje, Usuario, UsuarioR,Universidad } = this.state
        ...
        return (
            ...
            <div>
                <form on onSubmit={this.submitHandler}>
                    ...
                    <h1><span className="badge badge-primary">ReporteUniversidad </span>
                    ...
                    <  div className="container-fluid" align="center">
                        <div className="col-md-4 text-center">
                            ...
                            <div className="form-group">
                                ...
                                <h3><span className="badge badge-info">Universidad </span> </h3>

                                <input type="text" className="form-control" placeholder="IngreseUniversidad" aria-label="Username" aria-describedby="addon-wrapping" name="Universidad" value={Universidad} onChange={this.changeHandler} ></input>
