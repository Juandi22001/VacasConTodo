...
class ReporteConferencias extends Component{
 constructor(){
  super();
  this.state={
     id :'', 
...
var PromedioC =sumatoria/Promedio.length;
  ...
  if(I.Calificacion>6 && I.Tipo==="Conferencia"){  return ( 
...
<a className="navbar-brand" href="http://localhost:3000/" >Login</a>
 ...
 <h1><span className="badge badge-primary">Reporte Conferencias</span> 
...
export default ReporteConferencias
